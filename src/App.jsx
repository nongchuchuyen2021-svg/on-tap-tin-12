...
const essayDataOriginal = [
  {
    id: 1,
    text: "Câu 1: Hãy phân tích sự khác biệt về mặt bản chất giữa pseudo-class (lớp giả) và pseudo-element (phần tử giả) trong CSS. Đặt vào tình huống em đang thiết kế menu cho một website, nếu không sử dụng pseudo-class :hover, trải nghiệm của người dùng (UX) khi tương tác với trang web sẽ gặp hạn chế gì?",
  ...
  {
    id: 7,
    text: "Câu 7: Sau khi nhúng Google Forms vào Google Sites để làm biểu mẫu 'Thu thập ý kiến đóng góp của học sinh về thư viện trường', dữ liệu người dùng nhập vào sẽ được lưu trữ và thống kê ở đâu? Là người quản trị trang web, làm thế nào em có thể sử dụng các kết quả thống kê này một cách khoa học để đưa ra quyết định thay đổi nội dung trang web cho phù hợp hơn?",
  ...
  {
    id: 9,
    text: "Câu 9: Việc nhấp nút 'Công bố' (Publish) một website ra công chúng sẽ đi kèm với các rủi ro pháp lý về bản quyền (hình ảnh, âm thanh) và bảo mật thông tin cá nhân. Nếu được đóng vai trò là một 'Chuyên gia bảo mật hệ thống thông tin', em sẽ đưa ra 3 khuyến cáo gì cho các bạn trong lớp trước khi đưa website bài tập môn Tin học của mình lên Internet?",
